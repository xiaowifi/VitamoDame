...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
  ...
  SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback() {
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        android.util.Log.e(TAG, "surfaceChanged: 改变" );
      mSurfaceWidth = w;
      mSurfaceHeight = h;
    ...
    public void surfaceCreated(SurfaceHolder holder) {
      ...
      //&& mCurrentState == STATE_SUSPEND && mTargetState == STATE_RESUME
      if (mMediaPlayer != null && mCurrentState == STATE_SUSPEND && mTargetState == STATE_RESUME) {
        mMediaPlayer.setDisplay(mSurfaceHolder);
          android.util.Log.e(TAG, "surfaceCreated:创建 设置msurfaceholder" );
        resume();
      } else {
          android.util.Log.e(TAG, "surfaceCreated:重置 mMediaPlayer" );
        openVideo();
      }
    }

		public void surfaceDestroyed(SurfaceHolder holder) {
            android.util.Log.e(TAG, "surfaceChanged: 被干掉" );
			mSurfaceHolder = null;
			if (mMediaController != null)
				mMediaController.hide();
			release(true);
...
//      return;
  ...
  private void release(boolean cleartargetstate) {
      android.util.Log.e(TAG, "release: "+isfull );
	  /*  if (isfull){
	        return;
        }*/
    if (mMediaPlayer != null) {
