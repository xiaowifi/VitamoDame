...
public class MediaController extends FrameLayout {
  ...
  View.OnClickListener imgFull;
  View.OnClickListener tResolution;
  View.OnClickListener tSpeek;
  View.OnClickListener imgMore;
  ...
  private TextView t_resolution;
  private TextView t_speek;
  ...
  private void initControllerView(View v) {
    ...
    img_full = v.findViewById(R.id.img_full);
    t_resolution = v.findViewById(R.id.t_resolution);
    t_speek = v.findViewById(R.id.t_speek);
    img_move = findViewById(R.id.img_move);
    if (imgFull!=null){
      img_full.setOnClickListener(imgFull);
    }
    if (tResolution!=null){
      t_resolution.setOnClickListener(tResolution);
    }
    if (tSpeek!=null){
      t_speek.setOnClickListener(tSpeek);
    }
    if (imgMore!=null){
      img_move.setOnClickListener(imgMore);
    }
    if (mFileName != null)
      mFileName.setText(mTitle);
  }

  public void setImgMoreListener(View.OnClickListener onClickListener){
    this.imgMore=onClickListener;
  }
   ...
   * @param tSpeek
   */
  public void setControllerListener(View.OnClickListener imgFull,View.OnClickListener tResolution,View.OnClickListener tSpeek){
     this.imgFull=imgFull;
     this.tResolution=tResolution;
     this.tSpeek=tSpeek;
  }
  public ImageView getImgFull(){
    return img_full;
  }
  ...
  public void show(int timeout) {
    if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
      ...
      if (mFromXml) {
        android.util.Log.e(TAG, "show: true " );
        ...
        setWindowLayoutType();
        //pop 显示，第一参数是显示父容器。无重力，
        int i = dp2px(getContext(), 60);
        mWindow.showAtLocation(mAnchor, Gravity.NO_GRAVITY, anchorRect.left, anchorRect.bottom-i);
        android.util.Log.e(TAG, "show: false" +anchorRect.left+"底部参数"+anchorRect.bottom);
      }
      mShowing = true;
