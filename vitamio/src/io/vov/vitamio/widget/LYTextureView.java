 ...
 */
public class LYTextureView extends TextureView {

    private int videoHeight;
    private int videoWidth;

    public LYTextureView(Context context) {
        super(context);
    }

    public LYTextureView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LYTextureView(Context context, AttributeSet attrs, int defStyleAttr) {
